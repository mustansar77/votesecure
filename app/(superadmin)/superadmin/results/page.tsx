...
export default async function SuperAdminResultsPage() {
  ...
  return (
    <div className="p-6 lg:p-8">
      <div className="mb-8">
        <h1 className="text-2xl font-extrabold text-slate-900 dark:text-white">All Election Results</h1>
        <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">Live and final results across all elections.</p>
      </div>
